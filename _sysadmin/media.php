...
if ((!$_SESSION['medId'])||($_SESSION['medLevel']!=0)&&($_SESSION['medLevel']!=1)){
	...
	<div class="navbar-inner">
		<div class="container-fluid">
			<ul class="nav ace-nav">
				<li class="light-blue">
					<a href="#">
						<img src="<?php echo $_CONFIG['slogo'];?>" width="30px">
					</a>
				</li>
			</ul><!--/.ace-nav-->
			...
			<a href="#" class="brand">
				<small>
					<?php echo strtoupper($_CONFIG['sysappname']);?>
				</small>
			</a><!--/.brand-->

			<ul class="nav ace-nav pull-right">
				<?php
				if(!empty($_SESSION['medId'])){
					?>
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="../images/photo.jpg" alt="<?php echo $_SESSION['medNama'];?>">
							<span class="user-info">
								<small>Selamat Datang,</small><?php echo $_SESSION['medNama'];?>
							</span>
							<i class="icon-caret-down"></i>
						</a>
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<li><a href="?page=cpass"><i class="icon-cog"></i>Ubah Password</a></li>
