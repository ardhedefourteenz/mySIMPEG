...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<input class="input-xxlarge" type="text" id="pNama" name="pNama" required>
			</div>
		</div>
	...
	<?php
		if (isset($_POST['simpan'])){
		  	$q = mysql_query("INSERT INTO m_provinsi (pNama)
		  											VALUES('$_POST[pNama]')
		                    ");
			if ($q){
			echo "<script>
...
$e = mysql_fetch_array(mysql_query("SELECT * FROM m_provinsi WHERE pId='$_GET[id]'"));
$idx = $e['pId'];
?>
<div class="widget-box">
...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label" for="pNama">Nama</label>
			<div class="controls">
				<input class="input-xxlarge" type="text" id="pNama" name="pNama" value="<?php echo $e['pNama'];?>" required>
			</div>
		</div>
		<div class="form-actions">
			<button class="btn btn-info" type="submit" name="simpan">
	...
	<?php
		if (isset($_POST['simpan'])){
			...
			$q = mysql_query("UPDATE m_provinsi SET pNama ='$_POST[pNama]',
																 onUpdate=NOW()
			                      					WHERE pId = '$_POST[idx]'");
...
?>
	...
	<?php
		if ($_GET['mode']=="hapus"){
			mysql_query("DELETE FROM m_provinsi WHERE pId='$_GET[id]'");
			echo "<script>
	...
	<tbody>
	 <?php
	    $qry = mysql_query("SELECT * FROM m_provinsi");
		while ($d = mysql_fetch_array($qry)){
	      $no++;
	      echo "
	      <tr>
	      <td class='center'>$no</td>
	      <td class='left'>$d[pNama]</td>
	      <td class='center'>
            <div class='inline position-relative'>
              ...
              <ul class='dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close'>
                  <li>
                  	<a href='?page=$page&act=edit&id=$d[pId]' class='tooltip-success' data-rel='tooltip' data-original-title='Edit'>
                     	<span class='green'><i class='icon-edit bigger-120'></i></span>
                     	</a>
                  </li>
                  <li>
                  	<a href='?page=$page&mode=hapus&id=$d[pId]' onclick='return qh();' class='tooltip-error' data-rel='tooltip' data-original-title='Delete'>
